...
<!--<header class="l-header" id="header">
    <nav class="nav bd-container">
        <a href="#" class="nav__logo">SWEET BITE</a>

        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                <li class="nav__item"><a href="#home" class="nav__link active-link">Home</a></li>
                <li class="nav__item"><a href="#about" class="nav__link">About</a></li>
                <li class="nav__item"><a href="course.html" class="nav__link">Courses</a></li>
                <li class="nav__item"><a href="#" class="nav__link">Announcements</a></li>
                <li class="nav__item"><a href="#" class="nav__link">Events</a></li>
                <li class="nav__item">
                    <a href="register.php" class="nav__link logout__button">Logout</a>
                </li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Sweet Bite</h1>
                        <h2 class="home__subtitle">Turn your pastry <br> to success.</h2>
                        <a href="course.php" class="button">View Courses</a>
                    </div>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Pastry Chef turned <br> Entrepreneur</h2>
                        <p class="about__description">We teach the art of pastry making with passion, offering certified courses led by a skilled chef. From classic recipes to creative techniques, we provide hands-on training, expert guidance, and professional certification. Join us to master all kinds of pastries and elevate your baking skills to the next level!</p>
                        <a href="announcement.php" class="button">Explore Workshops</a>
                    </div>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content"><a href ="#">
                        ...
                        <h3 class="services__title">Event Booking</h3>
                        <p class="services__description">Book us for custom cakes, pastries, and savory dishes like pizza to make your event truly special!</p>
                    </div>
                    ...
                    <div class="services__content"><a href="#">
                        ...
                        <h3 class="services__title">Certified Courses</h3>
                        <p class="services__description">Enhance your skills with our certified courses in pastry making, baking, and savory creations. Learn from an expert chef and earn a professional certification!</p>
                    </div>
                    ...
                    <div class="services__content"><a href ="#">
                        ...
                        <h3 class="services__title">On Time Production</h3>
                        <p class="services__description">We ensure on-time production of all orders, delivering freshness and quality you can rely on!</p>
                    </div>
                </div>
            </section>
...
<section class="menu section bd-container" id="menu">
    ...
    <div class="menu__container bd-grid">
        <div class="menu__content">
            <img src="assets/img/home1.png" alt="" class="menu__img">
            <h3 class="menu__name">Cake Courses</h3>
            <span class="menu__detail">1 month </span>
            <span class="menu__preci">Rs.5,000.00</span>
           
        </div>

        <div class="menu__content">
            <img src="assets/img/cookie.png" alt="" class="menu__img">
            <h3 class="menu__name">Cookie Courses</h3>
            <span class="menu__detail">2 weeks</span>
            <span class="menu__preci">Rs.3,000</span>
            
        </div>
        
        <div class="menu__content">
            <img src="assets/img/pizza1.png" alt="" class="menu__img">
            <h3 class="menu__name">Savoury Goods</h3>
            <span class="menu__detail">3 Weeks</span>
            <span class="menu__preci">Rs.2,000</span>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    ...
                    <img src="assets/img/brownie.png" alt="" class="app__img">
                </div>
            </section>
